...
return array (
  ...
  'Requested range not satisfiable' => 'Angeforderter Bereich wird nicht bereitgestellt',
  ...
  'The file "{file}" is too big. Its size cannot exceed {limit} bytes.' => 'Die Datei "{file}" ist zu groß. Die Größe darf {limit} Byte nicht übersteigen.',
  'The file "{file}" is too large. The height cannot be larger than {limit} pixels.' => 'Die Datei "{file}" ist zu groß. Die Breite darf {limit} Pixels nicht übersteigen.',
  'The file "{file}" is too large. The width cannot be larger than {limit} pixels.' => 'Die Datei "{file}" ist zu groß. Die Höhe darf {limit} Pixels nicht übersteigen.',
  'The file "{file}" is too small. Its size cannot be smaller than {limit} bytes.' => 'Die Datei "{file}" ist zu klein. Die Größe darf {limit} Byte nicht unterrsteigen.',
  'The file "{file}" is too small. The height cannot be smaller than {limit} pixels.' => 'Die Datei "{file}" ist zu klein. Die Breite darf {limit} Pixels nicht untersteigen.',
  'The file "{file}" is too small. The width cannot be smaller than {limit} pixels.' => 'Die Datei "{file}" ist zu klein. Die Breite darf {limit} Pixels nicht untersteigen.',
  ...
  'You can upload at most {limit} files.' => 'Sie dürfen maximal {limit} Dateien hochladen.',
  ...
  '{attribute} should contain at least {min} characters.' => '{attribute} muss mindestens {min} Zeichen lang sein.',
  '{attribute} should contain at most {max} characters.' => '{attribute} darf höchstens {max} Zeichen lang sein.',
  '{attribute} should contain {length} characters.' => '{attribute} sollte {length} Zeichen lang sein.',
);
