...
If you already have a server configured or your application is not located in a folder called `advanced`, you may need to adjust the `$GLOBALS['TEST_ENTRY_URL']` in `frontend/tests/_bootstrap.php` and `backend/tests/_bootstrap.php`.
