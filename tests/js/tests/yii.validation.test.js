    ...
    describe('url validator', function () {
        ...
        describe('with basic configuration', function () {
            withData({
                ...
                'not allowed symbol (comma) after domain': ['https://example.com,', false],
                'not allowed symbol (star) after domain': ['https://example.com*12', false],
                'symbols after slash': ['https://example.com/*12', true],
                'get parameter without value': ['https://example.com/?test', true],
                'anchor': ['https://example.com/#test', true],
                'port, anchor': ['https://example.com:80/#test', true],
                'port (length equals limit), anchor': ['https://example.com:65535/#test', true],
                'port, get parameter without value': ['https://example.com:81/?good', true],
                'get parameter without value and slash': ['https://example.com?test', true],
                'anchor without slash': ['https://example.com#test', true],
                'port and anchor without slash': ['https://example.com:81#test', true],
                'port and get parameter without value and slash': ['https://example.com:81?good', true],
                'not allowed symbol after domain followed by get parameter without value': [
                    'https://example.com,?test',
                    false
                ],
                'skipped port and get parameter without value': ['https://example.com:?test', false],
                'skipped port and action': ['https://example.com:test', false],
                'port (length more than limit) and action': ['https://example.com:123456/test', false],
