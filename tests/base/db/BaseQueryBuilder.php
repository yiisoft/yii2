        ...
        $items = [
            ...
            [
                ...
                [
                    ...
                    'oci' => 'NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL PRIMARY KEY CHECK (value > 5)',
            ...
            [
                ...
                [
                    'mysql' => 'int NOT NULL AUTO_INCREMENT PRIMARY KEY CHECK (value > 5)',
                    'oci' => 'NUMBER(8) GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL PRIMARY KEY CHECK (value > 5)',
                ],
            ],
            [
                Schema::TYPE_PK . '(8)',
                ...
                [
                    ...
                    'oci' => 'NUMBER(8) GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL PRIMARY KEY',
                ],
            ],
            [
                Schema::TYPE_PK,
                ...
                [
                    ...
                    'sqlite' => 'integer PRIMARY KEY AUTOINCREMENT NOT NULL',
                    'oci' => 'NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL PRIMARY KEY',
