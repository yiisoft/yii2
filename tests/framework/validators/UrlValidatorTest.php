...
class UrlValidatorTest extends TestCase
{
    ...
    public function testValidateValue()
    {
        ...
        $this->assertFalse($val->validate('https://example.com,'));
        $this->assertFalse($val->validate('https://example.com*12'));
        $this->assertTrue($val->validate('https://example.com/*12'));
        $this->assertTrue($val->validate('https://example.com/?test'));
        $this->assertTrue($val->validate('https://example.com/#test'));
        $this->assertTrue($val->validate('https://example.com:80/#test'));
        $this->assertTrue($val->validate('https://example.com:65535/#test'));
        $this->assertTrue($val->validate('https://example.com:81/?good'));
        $this->assertTrue($val->validate('https://example.com?test'));
        $this->assertTrue($val->validate('https://example.com#test'));
        $this->assertTrue($val->validate('https://example.com:81#test'));
        $this->assertTrue($val->validate('https://example.com:81?good'));
        $this->assertFalse($val->validate('https://example.com,?test'));
        $this->assertFalse($val->validate('https://example.com:?test'));
        $this->assertFalse($val->validate('https://example.com:test'));
        $this->assertFalse($val->validate('https://example.com:123456/test'));
