...
class EmailValidatorTest extends TestCase
{
    ...
    public function emailProvider() {
        return [
            ...
            [false, true, false, 'после-преобразования-в-idn-тут-будет-больше-чем-64-символа@пример.com'],
            [false, true, true, 'Короткое имя <после-преобразования-в-idn-тут-будет-больше-чем-64-символа@пример.com>'],
