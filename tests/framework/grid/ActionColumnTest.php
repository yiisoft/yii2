...
class ActionColumnTest extends \yiiunit\TestCase
{
    ...
    public function testRenderDataCell()
    {
        ...
        $viewButton = '<a class="btn btn-default btn-sm" href="http://test.com" title="View" aria-label="View" data-pjax="0">View</a>';
        $updateButton = '<a class="btn btn-default btn-sm" href="http://test.com" title="Update" aria-label="Update" data-pjax="0">Update</a>';
        $deleteButton = '<a class="btn btn-default btn-sm" href="http://test.com" title="Delete" aria-label="Delete" data-pjax="0" data-confirm="Are you sure you want to delete this item?" data-method="post">Delete</a>';
