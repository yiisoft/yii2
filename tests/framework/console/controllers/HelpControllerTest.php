...
STRING
    ...
    public function testCommandsFilterOnActionList()
    {
        $this->mockApplication([
            'enableCoreCommands' => false,
        ...
        $this->assertContains("fake\n", $result);
        $this->assertContains("fake/default\n", $result);
        $this->assertContains("fake/second\n", $result);
    }

    public function testCommandsFilterOnActionIndex()
    {
        $this->mockApplication([
            'enableCoreCommands' => false,
            'controllerNamespace' => 'yiiunit\data\console\controllers',
        ...
        $this->assertContains("- fake", $result);
        $this->assertContains("    fake/default (default)", $result);
        $this->assertContains("    fake/second", $result);
    }
}
