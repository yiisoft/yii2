...
final class GridViewJqueryClientScriptTest extends \yiiunit\TestCase
{
    ...
    public function testRegisterWithNonGridViewObject(): void
    {
        $config = [
            'id' => 'test-grid',
            'dataProvider' => new ArrayDataProvider(['allModels' => []]),
        ...
        $nonGridViewObject = new BaseObject();

        $this->assertSame(
            [],
            $gridView->clientScript->getClientOptions($nonGridViewObject),
            "'getClientOptions()' method should return empty array for non-GridView objects.",
        );
    }
    ...
    public function testThrowUnknownMethodExceptionWhenRegisterWithNonGridViewObject(): void
    {
        $clientScript = new GridViewJqueryClientScript();
        $view = new View();
        $nonGridViewObject = new BaseObject();

        $this->expectException(UnknownMethodException::class);
        $this->expectExceptionMessage('Calling unknown method: yii\base\BaseObject::getView()');

        $clientScript->register($nonGridViewObject, $view);
    }
}
