...
class CubridQueryBuilderTest extends QueryBuilderTest
{
    ...
    public function columnTypes()
    {
        return [
            ...
            [Schema::TYPE_TEXT . '(255)', Schema::text(), 'varchar', Schema::TYPE_TEXT],
            [Schema::TYPE_TEXT . ' CHECK (value LIKE "test%")', Schema::text()->check('value LIKE "test%"'), 'varchar CHECK (value LIKE "test%")'],
            [Schema::TYPE_TEXT . '(255) CHECK (value LIKE "test%")', Schema::text()->check('value LIKE "test%"'), 'varchar CHECK (value LIKE "test%")', Schema::TYPE_TEXT . ' CHECK (value LIKE "test%")'],
            [Schema::TYPE_TEXT . ' NOT NULL', Schema::text()->notNull(), 'varchar NOT NULL'],
            [Schema::TYPE_TEXT . '(255) NOT NULL', Schema::text()->notNull(), 'varchar NOT NULL', Schema::TYPE_TEXT . ' NOT NULL'],
