...
class SqliteQueryBuilderTest extends QueryBuilderTest
{
    ...
    public function columnTypes()
    {
        return [
            ...
            [Schema::TYPE_SMALLINT, Schema::smallint(), 'smallint'],
            [Schema::TYPE_SMALLINT . '(8)', Schema::smallint(8), 'smallint'],
            ...
            [Schema::TYPE_BIGINT, Schema::bigint(), 'bigint'],
            [Schema::TYPE_BIGINT . '(8)', Schema::bigint(8), 'bigint'],
            [Schema::TYPE_BIGINT . ' CHECK (value > 5)', Schema::bigint()->check('value > 5'), 'bigint CHECK (value > 5)'],
            [Schema::TYPE_BIGINT . '(8) CHECK (value > 5)', Schema::bigint(8)->check('value > 5'), 'bigint CHECK (value > 5)'],
            [Schema::TYPE_BIGINT . ' NOT NULL', Schema::bigint()->notNull(), 'bigint NOT NULL'],
            ...
            [Schema::TYPE_BOOLEAN . ' NOT NULL DEFAULT 1', Schema::boolean()->notNull()->setDefault(1), 'boolean NOT NULL DEFAULT 1'],
