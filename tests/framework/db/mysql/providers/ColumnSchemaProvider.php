...
final class ColumnSchemaProvider extends \yiiunit\base\db\providers\ColumnSchemaProvider
{
    ...
    public static function defaultPhpTypecast(): array
    {
        return [
            ...
            'generated text literal becomes a PHP string' => [
                'text',
                'text',
                'string',
                "_utf8mb4\\'abc\\'",
            ...
            'generated empty text literal becomes an empty PHP string' => [
                'text',
                'tinytext',
                'string',
                "_utf8mb4\\'\\'",
            ...
            'generated text literal unescapes embedded escapes' => [
                'text',
                'text',
                'string',
                "_utf8mb4\\'a\\\\\\\\\\\\\\'b\\'",
            ...
            'generated blob literal becomes a PHP string' => [
                'binary',
                'blob',
                'resource',
                "_utf8mb4\\'abc\\'",
            ...
            'generated hex literal remains an expression' => [
                'text',
                'text',
                'string',
                '0x616263',
                new Expression('0x616263'),
                true,
            ],
            'generated text expression remains an expression' => [
                'text',
                'text',
                'string',
                "concat('A','B')",
                new Expression("concat('A','B')"),
                true,
            ],
            ...
            'generated quoted JSON literal remains an expression' => [
                'json',
                'json',
                'array',
                '_utf8mb4\\\'{"a":1}\\\'',
                new Expression('_utf8mb4\'{"a":1}\''),
                true,
            ],
            ...
            'MariaDB quoted text literal becomes a PHP string' => [
                'text',
                'text',
                'string',
                "'abc'",
            ...
            'MariaDB empty quoted text literal becomes an empty PHP string' => [
                'text',
                'tinytext',
                'string',
                "''",
            ...
            'MariaDB quoted text literal unescapes embedded escapes' => [
                'text',
                'text',
                'string',
                "'a\\\\\\'b'",
            ...
            'MariaDB text expression remains an expression' => [
                'text',
                'text',
                'string',
                "concat('A','B')",
