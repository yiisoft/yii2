...
class SchemaTest extends \yiiunit\framework\db\SchemaTest
{
    ...
    public function testGeneratedValues()
    {
        ...
        $connection->schema->refreshTableSchema('generated');
        $table = $connection->schema->getTableSchema('generated');
        ...
        $connection->createCommand()->dropTable('generated')->execute();
    }
    ...
    public function testPartitionedTable()
    {
        ...
        $connection->schema->refreshTableSchema('partitioned');
        $this->assertNotNull($connection->schema->getTableSchema('partitioned'));

        $connection->createCommand()->dropTable('partitioned')->execute();
    }
