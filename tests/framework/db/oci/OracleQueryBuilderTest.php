...
class OracleQueryBuilderTest extends QueryBuilderTest
{
    ...
    public function columnTypes()
    {
        return [
            ...
            [Schema::TYPE_SMALLINT, Schema::smallint(), 'NUMBER(5)'],
            [Schema::TYPE_SMALLINT . '(8)', Schema::smallint(8), 'NUMBER(8)'],
            ...
            [Schema::TYPE_BIGINT, Schema::bigint(), 'NUMBER(20)'],
            [Schema::TYPE_BIGINT . '(8)', Schema::bigint(8), 'NUMBER(8)'],
            [Schema::TYPE_BIGINT . ' CHECK (value > 5)', Schema::bigint()->check('value > 5'), 'NUMBER(20) CHECK (value > 5)'],
            [Schema::TYPE_BIGINT . '(8) CHECK (value > 5)', Schema::bigint(8)->check('value > 5'), 'NUMBER(8) CHECK (value > 5)'],
            [Schema::TYPE_BIGINT . ' NOT NULL', Schema::bigint()->notNull(), 'NUMBER(20) NOT NULL'],
