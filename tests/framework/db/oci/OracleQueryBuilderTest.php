...
class OracleQueryBuilderTest extends QueryBuilderTest
{
    ...
    public function columnTypes()
    {
        return [
            ...
            [Schema::TYPE_TEXT . '(255)', Schema::text(), 'CLOB', Schema::TYPE_TEXT],
            [Schema::TYPE_TEXT . ' CHECK (value LIKE \'test%\')', Schema::text()->check('value LIKE \'test%\''), 'CLOB CHECK (value LIKE \'test%\')'],
            [Schema::TYPE_TEXT . '(255) CHECK (value LIKE \'test%\')', Schema::text()->check('value LIKE \'test%\''), 'CLOB CHECK (value LIKE \'test%\')', Schema::TYPE_TEXT . ' CHECK (value LIKE \'test%\')'],
            [Schema::TYPE_TEXT . ' NOT NULL', Schema::text()->notNull(), 'CLOB NOT NULL'],
            [Schema::TYPE_TEXT . '(255) NOT NULL', Schema::text()->notNull(), 'CLOB NOT NULL', Schema::TYPE_TEXT . ' NOT NULL'],
