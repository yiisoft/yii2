...
//        $this->assertSame(false, $model->bool_col2);
    ...
    public function testMakingAutomaticRelationUpTo30CharsUnique()
    {
        ...
        $expectedSql = $this->replaceQuotes('SELECT [[customer]].* FROM [[customer]] LEFT JOIN [[order]] [[Customer<orders>]] ON [[customer]].[[id]] = [[Customer<orders>]].[[customer_id]] LEFT JOIN [[order_item]] [[Order<someVeryBigRelationTh_01>]] ON [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_01>]].[[order_id]] AND [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_01>]].[[quantity]] LEFT JOIN [[order_item]] [[Order<someVeryBigRelationTh_02>]] ON [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_02>]].[[order_id]] AND [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_02>]].[[quantity]] LEFT JOIN [[order_item]] [[Order<someVeryBigRelationTh_03>]] ON [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_03>]].[[order_id]] AND [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_03>]].[[quantity]] ORDER BY [[Customer<orders>]].[[id]]');
        $this->assertEquals($expectedSql, $customer->createCommand()->sql);
        ...
        $expectedSql = $this->replaceQuotes('SELECT [[customer]].* FROM [[customer]] LEFT JOIN [[order]] [[Customer<orders>]] ON [[customer]].[[id]] = [[Customer<orders>]].[[customer_id]] LEFT JOIN [[order_item]] [[Order<someVeryBigRelationTh_01>]] ON [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_01>]].[[order_id]] AND [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_01>]].[[quantity]] LEFT JOIN [[order_item]] [[Order<someVeryBigRelationTh_02>]] ON [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_02>]].[[order_id]] AND [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_02>]].[[quantity]] LEFT JOIN [[order_item]] [[Order<someVeryBigRelationTh_03>]] ON [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_03>]].[[order_id]] AND [[Customer<orders>]].[[id]] = [[Order<someVeryBigRelationTh_03>]].[[quantity]] LEFT JOIN [[order]] [[Customer<someVeryBigRelatio_01>]] ON [[customer]].[[id]] = [[Customer<someVeryBigRelatio_01>]].[[customer_id]] LEFT JOIN [[order]] [[Customer<someVeryBigRelatio_02>]] ON [[customer]].[[id]] = [[Customer<someVeryBigRelatio_02>]].[[customer_id]] LEFT JOIN [[order]] [[Customer<someVeryBigRelatio_03>]] ON [[customer]].[[id]] = [[Customer<someVeryBigRelatio_03>]].[[customer_id]] ORDER BY [[Customer<orders>]].[[id]]');
        $this->assertEquals($expectedSql, $customer->createCommand()->sql);
    }
