...
class FormatConverterTest extends TestCase
{
     ...
     */
    public function testEscapedIcuToPhpSinglePattern(string $pattern, string $expected): void
    {
     ...
     */
    public function testEscapedIcuToJuiSinglePattern(string $pattern, string $expected): void
    {
     ...
     */
    public function testPhpToICUSinglePattern(string $pattern, string $expected): void
    {
     ...
     */
    public function testEscapedPhpToJuiSinglePattern(string $pattern, string $expected): void
    {
