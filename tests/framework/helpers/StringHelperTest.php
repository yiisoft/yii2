...
class StringHelperTest extends TestCase
{
    ...
    public function testTruncate()
    {
        ...
        $this->assertEquals('<div><p>This is a test</p><ul><li>bullet1</li><li>b</li></ul></div>...', StringHelper::truncate('<div><p>This is a test</p><ul><li>bullet1</li><li>bullet2</li><li>bullet3</li><li>bullet4</li></ul></div>', 22, '...', null, true));
        $this->assertEquals('<div><p>This is a test</p><ul><li>bullet1</li><li>b</li></ul></div>...', StringHelper::truncate('<div><p>This is a test</p><ul><li>bullet1</li><li>bullet2</li><li>bullet3</li><li>bullet4</li></ul><br/></div>>', 22, '...', null, true));
    }
