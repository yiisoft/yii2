...
class ActiveField extends \yii\widgets\ActiveField
{
    ...
    {
        $this->renderToggleList('checkbox', $items, $options);
        return $this;
    }
    ...
    {
        $this->renderToggleList('radio', $items, $options);
        return $this;
    }
    ...
    /**
     * Renders a list of checkbox or radio toggle buttons.
     * This method is mainly called by [[checkboxToggleList()]] and [[radioToggleList()]].
     ...
     * @param array $options options (name => config) for the list.
     */
    protected function renderToggleList($type, $items, $options = [])
    {
        if (!isset($options['template'])) {
