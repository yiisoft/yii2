...
* Yii autoloader was removed in favor of Composer-generated one.
  See [guide on autoloading](https://github.com/yiisoft/yii2/blob/2.1/docs/guide/concept-autoloading.md).
