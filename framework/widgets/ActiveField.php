...
class ActiveField extends Component
{
     ...
     *   - `tag`: string|false, specifies the tag name for the label element. Defaults to `'label'`.
     *     - If set to `'label'` (default), uses [[Html::activeLabel()]] to generate a standard label element.
    ...
    public function radio($options = [], $enclosedByLabel = true)
    {
        ...
        if ($enclosedByLabel) {
            ...
            if (isset($options['label']) && !isset($this->parts['{label}'])) {
                ...
                $tag = $this->labelOptions['tag'] ?? 'label';
     ...
     *   in HTML code such as an image tag. If this is coming from end users, you should [[Html::encode()|encode]] it to
     *   prevent XSS attacks.
