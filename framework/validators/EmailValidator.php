...
class EmailValidator extends Validator
{
     ...
     * 注意：这个检查可能会因为DNS问题临时失败，即使邮箱地址是一个合法的地址且可以正常收发邮件。默认为 false。
     */
     ...
     * @var bool 校验过程是否应该考虑 IDN (国际化域名名称）。默认 false 意味着包含国际化名称的域名校验失败。
     * 注意，为了使用 IDN 校验，你必须安装且开启 `intl` PHP扩展，否则将会抛出异常。
     * @var bool
     */
