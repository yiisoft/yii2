...
/**
 * FilterValidatorJqueryClientScript provides client-side validation script generation for filter attributes.
 *
 * This class implements {@see ClientValidatorScriptInterface} to supply client-side validation options and register
 * the corresponding JavaScript code for filter validation in Yii2 forms using jQuery.
 *
 * @author Wilmer Arambula <terabytesoftw@gmail.com>
 * @since 2.2.0
 */
class FilterValidatorJqueryClientScript implements ClientValidatorScriptInterface
{
