 ...
 * the corresponding JavaScript code for string validation in Yii2 forms using jQuery.
 *
...
class StringValidatorJqueryClientScript implements ClientValidatorScriptInterface
{
    public function getClientOptions(Validator $validator, Model $model, string $attribute): array
    {
        ...
        if ($validator->min !== null) {
            ...
            $options['tooShort'] = $validator->formatMessage(
                $validator->tooShort,
                [
                    'attribute' => $label,
                    'min' => $validator->min,
        ...
        if ($validator->max !== null) {
            ...
            $options['tooLong'] = $validator->formatMessage(
                $validator->tooLong,
                [
                    'attribute' => $label,
                    'max' => $validator->max,
        ...
        if ($validator->length !== null) {
            ...
            $options['notEqual'] = $validator->formatMessage(
                $validator->notEqual,
                [
                   'attribute' => $label,
