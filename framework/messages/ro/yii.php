...
return [
    ...
    '{attribute} must not be greater than {max}.' => '«{attribute}» nu trebuie să fie mai mare ca {max}.',
    '{attribute} must not be less than {min}.' => '«{attribute}» nu trebuie să fie mai mic ca {min}.',
