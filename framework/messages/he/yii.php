...
return [
    ...
    '{attribute} must not be greater than {max}.' => '{attribute} חייב להיות לא יותר מ "{compareValue}".',
    '{attribute} must not be less than {min}.' => '{attribute} חייב להיות לא פחות מ "{min}".',
