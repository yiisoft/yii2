...
return array (
  ...
  '{attribute} must not be greater than {max}.' => 'Полето "{attribute}" не трябва да е по-голямо от {max}.',
  '{attribute} must not be less than {min}.' => 'Полето "{attribute}" не трябва да е по-малко от {min}.',
