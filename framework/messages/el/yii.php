...
return [
    ...
    '{attribute} must not be greater than {max}.' => 'Το «{attribute}» δεν πρέπει να ξεπερνά το {max}.',
    '{attribute} must not be less than {min}.' => 'Το «{attribute}» δεν πρέπει να είναι λιγότερο από {min}.',
