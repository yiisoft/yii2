...
return [
    ...
    'Total <b>{count, number}</b> {count, plural, one{item} other{items}}.' => 'Ukupno <b>{count, number}</b> {count, plural, one{red} other{redova}}.',
    ...
    'in {delta, plural, =1{a day} other{# days}}' => 'u {delta, plural, =1{dan} other{# dana}}',
    'in {delta, plural, =1{a minute} other{# minutes}}' => 'u {delta, plural, =1{minuta} other{# minuta}}',
    'in {delta, plural, =1{a month} other{# months}}' => 'u {delta, plural, =1{mjesec} other{# mjeseci}}',
    'in {delta, plural, =1{a second} other{# seconds}}' => 'u {delta, plural, =1{sekunda} other{# sekundi}}',
    'in {delta, plural, =1{a year} other{# years}}' => 'u {delta, plural, =1{godina} other{# godina}}',
    'in {delta, plural, =1{an hour} other{# hours}}' => 'in {delta, plural, =1{sat} other{# sati}}',
    ...
    '{attribute} must not be equal to "{compareValue}".' => '{attribute} ne smije biti jednnak "{compareValue}".',
    ...
    '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.' => '{attribute} moze sadržavati najviše do {max, number} {max, plural, one{znak} other{znakova}}.',
    ...
    '{delta, plural, =1{a year} other{# years}} ago' => '{delta, plural, =1{godina} other{# godina}}',
    '{delta, plural, =1{an hour} other{# hours}} ago' => ' {delta, plural, =1{sat} other{# sati}}',
    '{n, plural, =1{# byte} other{# bytes}}' => '{n, plural, =1{# bajt} other{# bajtova}}',
