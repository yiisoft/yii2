...
return [
    ...
    'At least {min, plural, one{one input} other{# inputs}} of {attributesList} must be filled.' => 'Хотя бы {min, plural, one{одно поле} few{# поля} many{# полей} other{# полей}} из {attributesList} должно быть заполнено.',
