...
return [
    ...
    '{attribute} must not be greater than {max}.' => 'Значение «{attribute}» не должно превышать {max}.',
    '{attribute} must not be less than {min}.' => 'Значение «{attribute}» должно быть не меньше {min}.',
