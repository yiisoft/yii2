...
return [
    ...
    '{attribute} must not be greater than {max}.' => '{attribute} musi wynosić nie więcej niż {max}.',
    '{attribute} must not be less than {min}.' => '{attribute} musi wynosić nie mniej niż {min}.',
