...
return [
    ...
    '{attribute} must not be greater than {max}.' => '{attribute} ne doit pas être supérieur à {max}.',
    '{attribute} must not be less than {min}.' => '{attribute} ne doit pas être inférieur à {min}.',
