...
return [
    ...
    'Home' => 'घर',
    'Invalid data received for parameter "{param}".' => 'पैरामीटर "{param}" के लिए अमान्य माहिती मिली।',
    ...
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.' => '<b>{totalCount, number}</b> {totalCount, plural, one{चीज} other{चीज़े}} में से दिखा रहा है <b>{begin, number}-{end, number}</b>।',
    'The combination {values} of {attributes} has already been taken.' => '{attributes} की {values} का संयोजन पहले से ही लिया जा चुका है।',
    'The file "{file}" is not an image.' => 'फ़ाइल "{file}" एक छवि नहीं है।',
    'The file "{file}" is too big. Its size cannot exceed {formattedLimit}.' => 'फ़ाइल "{file}" बहुत बड़ी है। इसका माप {formattedLimit} से अधिक नहीं हो सकता है।',
    'The file "{file}" is too small. Its size cannot be smaller than {formattedLimit}.' => 'फ़ाइल "{file}" बहुत छोटी है। इसका माप {formattedLimit} से छोटा नहीं हो सकता है।',
    'The format of {attribute} is invalid.' => '{attribute} का प्रारूप अमान्य है।',
    'The image "{file}" is too large. The height cannot be larger than {limit, number} {limit, plural, one{pixel} other{pixels}}.' => 'छवि "{file}" बहुत बड़ी है। ऊंचाई {limit, number} {limit, plural, one{पिक्सेल} अन्य {पिक्सेलस}} से बड़ी नहीं हो सकती।',
    'The image "{file}" is too large. The width cannot be larger than {limit, number} {limit, plural, one{pixel} other{pixels}}.' => 'छवि "{file}" बहुत बड़ी है। चौड़ाई {limit, number} {limit, plural, one{पिक्सेल} other{पिक्सेलस}} से बड़ी नहीं हो सकती।',
    'The image "{file}" is too small. The height cannot be smaller than {limit, number} {limit, plural, one{pixel} other{pixels}}.' => 'छवि "{file}" बहुत छोटी है। ऊंचाई {limit, number} {limit, plural, one{पिक्सेल} other{पिक्सेल}} से छोटी नहीं हो सकती।',
    'The image "{file}" is too small. The width cannot be smaller than {limit, number} {limit, plural, one{pixel} other{pixels}}.' => 'छवि "{file}" बहुत छोटी है। चौड़ाई {limit, number} {limit, plural, one{पिक्सेल} other{पिक्सेल}} से छोटी नहीं हो सकती।',
    ...
    'in {delta, plural, =1{a day} other{# days}}' => 'में {delta, plural, =1{एक दिन} other{# दिनों}}',
    'in {delta, plural, =1{a minute} other{# minutes}}' => 'में {delta, plural, =1{एक मिनट} other{# मिनट}}',
    'in {delta, plural, =1{a month} other{# months}}' => 'में {delta, plural, =1{एक महीना} other{# महीने}}',
    'in {delta, plural, =1{a second} other{# seconds}}' => 'में {delta, plural, =1{एक सेकन्ड} other{# सेकन्डे}}',
    'in {delta, plural, =1{a year} other{# years}}' => 'में {delta, plural, =1{एक वर्ष} other{# वर्षे}}',
    'in {delta, plural, =1{an hour} other{# hours}}' => 'में {delta, plural, =1{एक घंटा} other{# घंटे}}',
    'just now' => 'अभी',
    'the input value' => 'इनपुट मूल्य',
    '{attribute} "{value}" has already been taken.' => '{attribute} "{value}" पहले से ही ले लिया गया है।',
    '{attribute} cannot be blank.' => '{attribute} खाली नहीं हो सकती।',
    ...
    '{attribute} must be an IP address with specified subnet.' => '{attribute} निर्दिष्ट सबनेट के साथ एक IP एड्रेस होना चाहिए।',
    ...
    '{delta, plural, =1{1 minute} other{# minutes}}' => '{delta, plural, =1{1 मिनट} other{# मिनट}}',
    ...
    '{delta, plural, =1{a second} other{# seconds}} ago' => '{delta, plural, =1{एक दूसरा} other{# सेकंड}} पहले',
    ...
    '{nFormatted} {n, plural, =1{gibibyte} other{gibibytes}}' => '{nFormatted} {n, plural, =1{गिबिबाईट} other{गिबिबाईटस}}',
    '{nFormatted} {n, plural, =1{gigabyte} other{gigabytes}}' => '{nFormatted} {n, plural, =1{गीगाबाइट} other{गीगाबाइटस}}',
    '{nFormatted} {n, plural, =1{kibibyte} other{kibibytes}}' => '{nFormatted} {n, plural, =1{किबिबाईट} other{किबिबाईटस}}',
    '{nFormatted} {n, plural, =1{kilobyte} other{kilobytes}}' => '{nFormatted} {n, plural, =1{किलोबाइट} other{किलोबाइट्स}}',
    '{nFormatted} {n, plural, =1{mebibyte} other{mebibytes}}' => '{nFormatted} {n, plural, =1{मेबीबाईट} other{मेबीबाईटस}',
    '{nFormatted} {n, plural, =1{megabyte} other{megabytes}}' => '{nFormatted} {n, plural, =1{मेगाबाइट} other{मेगाबाइट्स}}',
    '{nFormatted} {n, plural, =1{pebibyte} other{pebibytes}}' => '{nFormatted} {n, plural, =1{पेबिबाईट} other{पेबिबाईटस}',
    '{nFormatted} {n, plural, =1{petabyte} other{petabytes}}' => '{nFormatted} {n, plural, =1{पेटाबाइट} other{पेटाबाइट्स}}',
    '{nFormatted} {n, plural, =1{tebibyte} other{tebibytes}}' => '{nFormatted} {n, plural, =1{तबीबाईट} other{तबीबाईटस}}',
