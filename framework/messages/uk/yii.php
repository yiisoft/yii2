...
return [
    ...
    '{attribute} must not be greater than {max}.' => 'Значення "{attribute}" не повинно перевищувати {max}.',
    '{attribute} must not be less than {min}.' => 'Значення "{attribute}" має бути більшим {min}.',
