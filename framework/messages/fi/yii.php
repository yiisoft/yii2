...
return [
    ...
    '{attribute} must not be greater than {max}.' => '{attribute} ei saa olla suurempi kuin "{max}".',
    '{attribute} must not be less than {min}.' => '{attribute} ei saa olla pienempi kuin "{min}".',
