...
return [
    ...
    '{attribute} must not be greater than {max}.' => '{attribute} darf nicht größer als {max} sein.',
    '{attribute} must not be less than {min}.' => '{attribute} darf nicht kleiner als {min} sein.',
