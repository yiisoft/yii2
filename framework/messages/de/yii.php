...
return [
    ...
    'You are not allowed to perform this action.' => 'Diese Aktion ist ungültig.',
    ...
    '{attribute} must be a number.' => '{attribute} Die Eingabe einer Zahl ist erforderlich.',
    ...
    '"{attribute}" does not support operator "{operator}".' => '"{attribute}" wird nicht vom Server "{operator}" unterstützt.',
