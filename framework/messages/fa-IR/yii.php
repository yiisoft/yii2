...
return [
    ...
    '{attribute} must not be greater than {max}.' => '{attribute} نباید بیشتر از "{compareValue}" باشد.',
    '{attribute} must not be less than {min}.' => '{attribute} نباید کمتر از "{compareValue}" باشد.',
