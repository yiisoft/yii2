...
return [
    ...
    '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.' => '{attribute}-ի արժեքը պետք է պարունակի առավելագույնը {min, number} {min, plural, one{նիշ} other{նիշ}}։',
    '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.' => '{attribute}-ի արժեքը պետք է պարունակի {min, number} {min, plural, one{նիշ} other{նիշ}}։',
