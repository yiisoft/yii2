...
return [
    ...
    '{attribute} must not be greater than {max}.' => '{attribute} mag niet groter zijn dan {max}.',
    '{attribute} must not be less than {min}.' => '{attribute} mag niet kleiner zijn dan {min}.',
