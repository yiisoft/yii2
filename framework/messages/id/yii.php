...
return [
    ...
    '{attribute} must not be greater than {max}.' => '{attribute} harus tidak boleh lebih besar dari {max}.',
    '{attribute} must not be less than {min}.' => '{attribute} harus tidak boleh lebih kecil dari {min}.',
