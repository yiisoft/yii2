...
return array (
  ...
  '{attribute} must not be greater than {max}.' => '{attribute} ei tohi olla suurem kui {max}.',
  '{attribute} must not be less than {min}.' => '{attribute} ei tohi olla väiksem kui {min}.',
