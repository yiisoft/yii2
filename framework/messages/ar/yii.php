...
return [
    ...
    '{attribute} must not be greater than {max}.' => '{attribute} يجب أن لا يكون أكبر من "{compareValue}".',
    '{attribute} must not be less than {min}.' => '{attribute} يجب أن لا يكون أصغر من "{min}".',
