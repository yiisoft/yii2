...
return [
    ...
    'Missing required parameters: {params}' => 'Недостају обавезни параметри: {paramsЂ',
    'No' => 'Не',
    ...
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.' => 'Приказано <b>{begin, number}-{end, number}</b> од <b>{totalCount, number}</b> {totalCount, plural, 0={ставки} 1={ставка} 2={ставке} 3={ставке} 4={ставке} other{ставки}}.',
