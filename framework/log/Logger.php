 ...
 *
 * @property-read array{int, int|float} $dbProfiling The first element indicates the number of SQL statements executed, and
 ...
 * @property-read list<ProfilingTiming> $profiling The profiling results. Each element is an array consisting of these
 ...
 *   0: string|array<array-key, mixed>|\Throwable|PsrMessage,
 *   1: int,
 *   2: string,
 *   3: float,
 *   4: list<LogTrace>,
 *   5?: int
 * }
 * @phpstan-type ProfilingTiming array{
 *   info: string|array<array-key, mixed>|\Throwable|PsrMessage,
 *   category: string,
 *   timestamp: float,
 *   trace: list<LogTrace>,
 *   level: int,
...
class Logger extends Component
{
    ...
    /**
     * @var array<int|string, LogMessage> logged messages. This property is managed by [[log()]] and [[flush()]].
     ...
     * @param string|array|\Throwable|PsrMessage $message the message to be logged. This can be a simple string or a more
     ...
     *
     * @param list<string> $categories list of categories that you are interested in.
     * You can use an asterisk at the end of a category to do a prefix match.
     * For example, 'yii\db\*' will match categories starting with 'yii\db\',
     * such as 'yii\db\Connection'.
     * @param list<string> $excludeCategories list of categories that you want to exclude
     * @return list<ProfilingTiming> the profiling results. Each element is an array consisting of these elements:
     ...
     * @return array{int, int|float} the first element indicates the number of SQL statements executed,
     ...
     * @param array<int|string, LogMessage> $messages the log messages obtained from profiling
     * @return list<ProfilingTiming> timings. Each element is an array consisting of these elements:
     * `info`, `category`, `timestamp`, `trace`, `level`, `duration`, `memory`, `memoryDiff`.
     * The `memory` and `memoryDiff` values are available since version 2.0.11.
     */
