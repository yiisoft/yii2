...
class FileTarget extends Target
{
    ...
    /**
     * @var int 最大日志文件大小，以千字节为单位。 默认为10240，表示10MB。
     */
    public $maxFileSize = 10240; // in KB
    /**
     * @var int 用于轮换的日志文件数。 默认为5。
     */
    public $maxLogFiles = 5;
    /**
     * @var int 为新创建的日志文件设置的权限。
     * 该值将由PHP chmod() 函数使用。没有默认值。
     * 如果未设置，权限将由当前环境确定。
     */
    public $fileMode;
    /**
     ...
     * 并且在Windows系统中不能很好地重命名已打开的文件。
     * 但是，通过重命名进行旋转要快一点。
     *
     *
     * 在PHP文档中 [comment by Martin Pelletier](http://www.php.net/manual/en/function.rename.php#102274) 中描述了Windows
