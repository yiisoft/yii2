...
/**
 * BaseLogger provides concrete implementation for [[Logger]].
 *
 * Do not use BaseLogger. Use [[Logger]] instead.
 *
 ...
 * @since 2.0.4
 */
class BaseLogger extends Component
{
    /**
     ...
     */
    protected function logInternal($message, $level, $category = 'application')
    {
        $time = microtime(true);
        $traces = [];
