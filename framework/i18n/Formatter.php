 ...
 * 要使此功能起作用，必须安装 [PHP intl extension](http://php.net/manual/en/book.intl.php) 扩展。
 ...
 * > 请使用 PHP [date()](http://php.net/manual/en/function.date.php) 函数。
 *
...
class Formatter extends Component
{
     ...
     * 对于数字和日期格式，
     * 只有在安装了 [PHP intl extension](http://php.net/manual/en/book.intl.php) 时才有效。
