...
return array (
  ...
  'Invalid data received for parameter "{param}".' => 'Dati ricevuti non correti per il parametro  "{param}".',
  ...
  'Unknown Class' => 'Class Sconosciuta',
  ...
  'You can upload at most {limit, number} {limit, plural, one{file} other{files}}.' => 'Puoi eseguire il caricamento massi di questo numero di file {limit, number} {limit, plural, one{file} other{files}}.',
