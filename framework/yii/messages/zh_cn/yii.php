...
return array (
  ...
  'Total <b>{count, number}</b> {count, plural, one{item} other{items}}.' => '总计 <b>{count, number}</b> 条',
  'Unable to verify your data submission.' => '您提交的数据无法被验证',
  'Unknown command "{command}".' => '未知的命令： "{command}".',//TODO: Here missed a colon ":"
  ...
  '{attribute} must be either "{true}" or "{false}".' => '{attribute}的值必须要么为"{true}"，要么为"{false}"。',//OR 要么为真，要么为假？
  ...
  '{attribute} must be repeated exactly.' => '{attribute}必须重复。',//TODO: A bit weird
