	...
	<table class="table table-bordered table-striped table-condensed">
		...
		<tbody>
			...
			<tr class="<?php echo $file->operation; ?>">
				<td class="file">
					<?php echo Html::a(Html::encode($file->getRelativePath()), ['preview', 'file' => $file->id], ['class' => 'preview-code', 'data-title' => $file->getRelativePath()]); ?>
					<?php if ($file->operation === CodeFile::OP_OVERWRITE): ?>
						<?php echo Html::a('diff', ['diff', 'file' => $file->id], ['class' => 'diff-code label label-warning', 'data-title' => $file->getRelativePath()]); ?>
					<?php endif; ?>
				</td>
				<td class="action">
					<?php
