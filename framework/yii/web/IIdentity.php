...
/**
 * IIdentity is the interface that should be implemented by a class providing identity information.
 *
...
interface IIdentity
{
	 ...
	 * @return IIdentity the identity object that matches the given ID.
