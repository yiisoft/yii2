 ...
 *
 * User works with a class implementing the [[IIdentity]] interface. This class implements
 * the actual user authentication logic and is often backed by a user database table.
 *
 * @property string|integer $id The unique identifier for the user. If null, it means the user is a guest.
 * This property is read-only.
 * @property IIdentity $identity The identity object associated with the currently logged user. Null is
...
class User extends Component
{
	 ...
	 * @return IIdentity the identity object associated with the currently logged user.
	 ...
	 * or [[switchIdentity()]].
	 *
	 * @param IIdentity $identity the identity object associated with the currently logged user.
	 */
	 ...
	 *
	 * @param IIdentity $identity the user identity (which should already be authenticated)
	 ...
	 * @param IIdentity $identity the user identity information
	 ...
	 * It saves [[id]], [[IIdentity::getAuthKey()|auth key]], and the duration of cookie-based login
	 ...
	 *
	 * @param IIdentity $identity the identity information to be associated with the current user.
