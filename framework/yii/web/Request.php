 ...
 * @property array $acceptedContentTypes The content types ordered by the preference level.
 * The first element represents the most preferred content type.
 * @property array $acceptedLanguages The languages ordered by the preference level.
 * The first element represents the most preferred language.
 * @property string $baseUrl The relative URL for the application.
 * @property string $cookieValidationKey The secret key used for cookie validation. 
 ...
 * @property string $serverName Server name of the request URL (e.g. `www.yiiframework.com`).
