...
class QueryBuilder extends \yii\base\Object
{
    ...
    /**
     * Builds arrays of quoted column names and param placeholders.
     * @param string $table the table that new rows will be inserted into.
     * @param array $columns the column data (name => value) to be inserted into the table.
     * @param array $params the binding parameters that will be generated by this method.
     * They should be bound to the DB command later.
     * @return array contains two arrays: names and placeholders
     */
    protected function prepareInsertColumns($table, $columns, &$params)
    {
    ...
    public function insert($table, $columns, &$params)
    {
        ...
        return 'INSERT INTO ' . $this->db->getSchema()->quoteTableName($table)
            . ' (' . implode(', ', $names) . ') VALUES ('
            . implode(', ', $placeholders) . ')';
    }

    /**
     * Creates an INSERT INTO RETURNING SQL statement or plain INSERT if the underlying DBMS does not support it.
     * @see insert()
     *
     * @param string $table the table that new rows will be inserted into.
     * @param array $columns the column data (name => value) to be inserted into the table.
     * @param array $params the binding parameters that will be generated by this method.
     * They should be bound to the DB command later.
     * @param array $returnColumns table column names to be returned
     * @param array $returnParams either true, when column values are returned as query results,
    ...
    /**
     * Creates assignment expression for the SET part of the UPDATE command.
     * @param string $table the table to be updated.
     * @param array $columns the column data (name => value) to be updated.
     * @param array $params the binding parameters that will be modified by this method
     * so that they can be bound to the DB command later.
     * @return array columnName => param pairs
     */
    protected function prepareUpdateColumns($table, $columns, &$params)
    {
    ...
    {
        $lines = $this->prepareUpdateColumns($table, $columns, $params);
