...
abstract class BaseActiveRecord extends Model implements ActiveRecordInterface
{
     ...
     * @param string $name the relation name (case-sensitive). If relation is defined as `public function getCustomerOrders()` in the model the relation name is `customerOrders`.
     ...
     * @param string $name the relation name. If relation is defined as `public function getCustomerOrders()` in the model the relation name is `customerOrders`.
     ...
     *
     * @param string $name the case sensitive name of the relationship. If relation is defined as `public function getCustomerOrders()` in the model the relation name is `customerOrders`.
