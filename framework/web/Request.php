 ...
 * `http://www.yiiframework.com`), null if not present $_SERVER['HTTP_HOST'] or $_SERVER['SERVER_NAME']
 * or not set manually before.
 ...
 * @property string $serverName Server name, null if not present. This property is read-only.
 * @property integer $serverPort Server port number, null if not present. This property is read-only.
...
class Request extends \yii\base\Request
{
     ...
     * null if not present $_SERVER['HTTP_HOST'] or $_SERVER['SERVER_NAME'] or not set manually before.
     * @see setHostInfo()
     */
     ...
     * @return string server name, null if not present
     */
     ...
     * @return integer server port number, null if not present
     */
