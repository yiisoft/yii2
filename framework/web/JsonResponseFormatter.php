...
class JsonResponseFormatter extends Component implements ResponseFormatterInterface
{
    ...
    {
        $response->getHeaderCollection()->set('Content-Type', 'application/json; charset=UTF-8');
    ...
    {
        $response->getHeaderCollection()->set('Content-Type', 'application/javascript; charset=UTF-8');
