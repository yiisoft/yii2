...
use yii\rbac\AuthorizerInterface;
...
class User extends Component
{
    ...
    public $authTimeout;
    /**
     * @var AuthorizerInterface The authorizer to use for checking access.
     * If not set the applications' auth manager will be used.
     */
    public $authorizer;
    /**
     ...
     * [[\yii\rbac\AuthorizerInterface::checkAccess()]] to obtain the up-to-date access result. Note that this
    ...
    public function can($permissionName, $params = [], $allowCaching = true)
    {
        ...
        if (($authorizer = $this->getAuthorizer()) === null) {
            return false;
        }
        $access = $authorizer->checkAccess($this->getId(), $permissionName, $params);
     ...
     * @since 2.0.6
     * @deprecated Marked as deprecated since we have `getAuthorizer()`.
     */
    ...
    /**
     * Returns the authorizer used for checking access.
     * @return AuthorizerInterface
     * @since 2.0.9
     */
    protected function getAuthorizer()
    {
        return isset($this->authorizer) ? $this->authorizer : $this->getAuthManager();
    }
}
