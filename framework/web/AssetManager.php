...
class AssetManager extends Component
{
     ...
     * - directoryName: string, sets the target directory name where assets being published will be resided.
     *   If the name is undefined, it's going to be generated by the [[hash]] method.
     *
