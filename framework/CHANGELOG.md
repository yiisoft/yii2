...
- Enh #11490: added ability to invalidate all active user sessions by changing the value of `IdentityInterface::getAuthKey()` associated with the user (PowerGamer1)
