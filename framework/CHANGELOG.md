...
- Bug #13828: Retrieving inserted data for a primary key request of type uniqueidentifier(issue 13828) or trigger (issue 17474) (for SQL Server 2005 or later) (darkdef)
