...
- Chg #7551: `yii\web\Request::$pathInfo` refactored to be an array of path parts (separated by '/') instead of string, allowing handing of url-encoded slashes (klimov-paul)
