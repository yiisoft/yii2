...
- Enh #10218: `yii.gridView.js` added support for selectig in filter multiple values with same name (omnilight, silverfire)
- Enh #10264: Generating of HTML tags in in yii.* JS redone in jQuery style (silverfire)
