...
- Bug #3791: Fix `FileValidator` to check tempName on mime-type (Ragazzo)
...
- Enh #3773: `FileValidator` adjusted to handle file mime-types detecting (Ragazzo)
...
- Chg #3804: Check for `fileinfo` extension added to requirements checker (Ragazzo)
