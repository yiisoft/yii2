...
- Enh #14323: Visibility level of the method `yii\i18n\MessageSource::loadMessages()` changed to 'public', allowing to get all messages per single category (klimov-paul)
- Enh #14845: Added method `yii\i18n\MessageSource::save()`, allowing to save messages per single category (klimov-paul)
