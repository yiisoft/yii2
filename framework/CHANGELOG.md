...
- Enh #17560: Allowed callable objects to be set to `\yii\validators\ExistValidator::$filter` `\yii\validators\DefaultValueValidator::$value` `\yii\validators\RangeValidator::$range` `\yii\validators\UniqueValidator::$filter` (DrDeath72)
