...
- Enh #384: Added support for namespaced migrations via [[yii\console\controllers\BaseMigrateController::migrationNamespaces]] and ability to run migration from several locations (klimov-paul)
