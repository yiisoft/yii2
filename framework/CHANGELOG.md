...
------------------------
- Bug #14467: In case of a failed negotiation `yii\filters\ContentNegotiator` now generates "406 Not Acceptable" HTTP status code in compliance with HTTP 1.1 specification (PowerGamer1)
