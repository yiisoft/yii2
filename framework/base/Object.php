...
class Object implements Configurable
{
    ...
    public function __get($name)
    {
        ...
        if (method_exists($this, $getter) && is_callable([$this, $getter])) {
            return $this->$getter();
        } elseif (method_exists($this, 'set' . $name) && is_callable([$this, 'set' . $name])) {
    ...
    public function __set($name, $value)
    {
        ...
        if (method_exists($this, $setter) && is_callable([$this, $setter])) {
            $this->$setter($value);
        } elseif (method_exists($this, 'get' . $name) && is_callable([$this, 'get' . $name])) {
    ...
    {
        return method_exists($this, 'get' . $name) && is_callable([$this, 'get' . $name]) || $checkVars && property_exists($this, $name);
    }
    ...
    {
        return method_exists($this, 'set' . $name) && is_callable([$this, 'set' . $name]) || $checkVars && property_exists($this, $name);
    }
    ...
    {
        return method_exists($this, $name) && is_callable([$this, $name]);
    }
}
