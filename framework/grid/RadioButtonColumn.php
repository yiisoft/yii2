...
class RadioButtonColumn extends Column
{
    ...
    /**
     * @var array|\Closure the HTML attributes for radio buttons. This can either be an array of
     ...
     * Specifically if you want to set a different value for the radio button
    ...
    protected function renderDataCellContent($model, $key, $index)
    {
        ...
        return Html::radio($this->name, false, $options);
    }
}
