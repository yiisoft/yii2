...
class ActionColumn extends Column
{
     ...
     * @deprecated string $iconName The part of Bootstrap glyphicon class that makes 
     * it unique. Deprecated since 2.0.16
     * @param array $additionalOptions Array of additional options
     * @since 2.0.11
     */
    protected function initDefaultButton($name, $iconName=null, $additionalOptions = [])
    {
