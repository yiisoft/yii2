...
class DataColumn extends Column
{
     ...
     *
     * - If this property is not set, a text field will be generated as the filter input with attributes by filterInputOptions;
     * @see $filterInputOptions;
     * @see \yii\helpers\BaseHtml::activeInput for details on how generated an active input tag.
     ...
     * Note empty id is included to the better speed of render filter tag and avoid running the getter
     * for id by model and attribute by default.
     * @see \yii\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
     */
