...
Обидва шаблони проекту вже мають консольний додаток в комплекті.
Ви можете запустити його, викликав скрипт `yii`, який розміщений у базовій директорії додатка.
...
якщо ви не хочете бачити стек [трасування](tracing) при помилці, і/або якщо ви хочете підвищити загальну продуктивність. І в базовому, і в розширеному шаблонах
...
> Підказка: Іноді, існує необхідність запускати консольну команду, використовуючи конфігурацію додатка, яка
...
визначаються одна або більше дій, які відповідають під-командами контролера. Всередині кожної дії міститься код, який реалізує відповідні завдання для окремої під-команди.
