...
Заголовок `Cache-Control` визначає загальну політику кешування сторінок. Ви можете вмикати його відправку, налаштовувати властивість [[yii \ filters \ HttpCache :: cacheControlHeader]]. За замовчуванням буде відправлений наступний заголовок:
