...
> Note: За замовчуванням, HTTP-server буде прослуховувати 8080 порт. Проте, 
якщо цей порт вже використовується або Ви бажаєте таким чимнов використовувати 
...
* Скопіюйте `/requirements.php` файл до `/web/requirements.php` та використайте браузер для доступу до URL `http://localhost/requirements.php`
