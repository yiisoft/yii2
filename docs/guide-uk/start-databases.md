...
Ви можете створити SQLite, MySQL, PostgreSQL, MSSQL або Oracle базу даних, Yii має вбудовану підтримку для багатьох баз даних.
...
> Інформація: Якщо не можливо отримати прямої відповідності імені класу до імені таблиці, ви можете
...
Щоб представити дані про країну кінцевим користувачам, необхідно створити нову дію. Замість розміщення нової дії 
...
Наприкінці, дія `index` формує представлення з іменем `index` та передає до нього дані по країнах  із інформацією про по-сторінкове
розділення.
