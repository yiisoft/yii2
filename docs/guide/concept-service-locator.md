...
Added benefit is the option for a developer to override configuration locally.

Any request for a service to be retrieved from a Module will be passed on to its parent in case the module is not able to satify it.
