...
> Tip: Grid ids are autogenerated unless explicitly set. The above example assumes the user explicity set the grid id to 
> "grid". [How to set the grid id](https://www.yiiframework.com/doc/api/2.0/yii-base-widget#$id-detail).
