...
Inside your controller there are few ways to implement authorization. If you want granular permissions that
...
If all the CRUD operations are managed together then it's a good idea to use a single permission managePost and check it in [[yii\web\Controller::beforeAction()]].
