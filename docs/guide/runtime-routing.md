...
> Note: If [[yii\web\UrlRule::$pattern|pattern]] contains only optional params and slashes, first parameter could be omitted 
  only if all other params are omitted.
