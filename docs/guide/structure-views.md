...
[caching result](caching-overview.md).
...
to learn more refer to [Using template engines](tutorial-template-engines.md) section of the guide.
...
To learn about caching of view fragments please refer to [caching](caching-overview.md) section of the guide.
