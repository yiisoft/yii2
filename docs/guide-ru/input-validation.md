...
* Название метода проверки в модели класса, или анонимную функцию. Пожалуйста, обратитесь к разделу
  [Встроенных валидаторов](#Встроенные-Валидаторы-) за более подробной информацией.
* Полное имя класса валидатора. Пожалуйста, обратитесь к разделу [Автономных валидаторов](#Автономные-валидаторы-)
...
Правило может быть применено только к определенным [сценариям](structure-models.md#Сценарии-) указав свойство `on`.
...
с помощью [trim](tutorial-core-validators.md#yiivalidatorsfiltervalidatortrim-) и указать значения по умолчанию с помощью свойства
[default](tutorial-core-validators.md#yiivalidatorsdefaultvaluevalidatordefault-) основного валидатора:
...
Вы также можете использовать более сложные фильтрации данных с помощью анонимной функции
 подробнее об этом [filter](tutorial-core-validators.md#yiivalidatorsfiltervalidatorfilter-).
...
валидатора [default](tutorial-core-validators.md#yiivalidatorsdefaultvaluevalidatordefault-). Например:
...
[unique](tutorial-core-validators.md#yiivalidatorsuniquevalidatorunique-) валидатор, который предназначен для работы с моделью.
...
чтобы сохранить сообщение об ошибке в модели, как это делают [встроенные валидаторы](#Встроенные-Валидаторы-). Например:
...
Например, `LoginForm` ниже объявляет два правила: один использует [required](tutorial-core-validators.md#yiivalidatorsrequiredvalidatorrequired-)
...
> [in](tutorial-core-validators.md#yiivalidatorsrangevalidatorin-) основные валидаторы для достижения той же цели.
...
> Info: Вы также можете использовать [Deferred Validation](#Отложенная-валидация-) AJAX валидации.
