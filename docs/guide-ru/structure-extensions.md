...
[базовая директория](structure-applications.md#yiibaseapplicationbasepathbasepath-) приложения. Composer - это менеджер зависимостей, и поэтому
...
сделать, это объявить [псевдоним](concept-aliases.md#Создание-псевдонимов-) для корневого каталога расширения. Например,
...
[псевдоним](concept-aliases.md#Псевдонимы-расширений-), который указывает на директорию, соответствующую пространству имён.
...
[Использование расширений](#Использование-расширений-).
