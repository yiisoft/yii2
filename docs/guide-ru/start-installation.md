...
После установки Composer устанавить Yii можно запустив следующие команды в директории доступной через веб(в которой будет ваш сайт):
1) первая команда установит специальный плагин к Композеру для правильной его работы 
```
composer global require "fxp/composer-asset-plugin:1.0.0-beta3"
```
2) вторая команда установит приложение `basic` и загрузит все необходимые зависимости в том числе и сам Yii-фрэймворк:
- в процессе установки нужно будет ввести ваш USERNAME/PASSWORD от [github.com](https://github.com)
- после загрузки всех зависимостей автоматически будет произведена реконфигурация приложения, а также если Вы используете  unix подбную систуму будут выставленные разрешения чтения/записи на необходимые директории.
```
