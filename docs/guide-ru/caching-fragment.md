...
> Примечание: начиная с версии 2.0.14 динамическое содержимое API открывается через [[yii\base\DynamicContentAwareInterface]] интерфейс и его [[yii\base\DynamicContentAwareTrait]] трейт.
  В качестве примера вы можете обратится к классу [[yii\widgets\FragmentCache]].
