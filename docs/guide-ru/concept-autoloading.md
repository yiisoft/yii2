...
либо `@foo` либо `@foo/bar` являлся [корневым псевдонимом](concept-aliases.md#Создание-псевдонимов-).
...
является [заранее определённым псевдонимом](concept-aliases.md#Заранее-определённые-псевдонимы-) и такое имя класса как
