...
8. Действие загружает некоторые модели данных, вероятнее всего из базы данных.
9. Действие генерирует вид, отображая в нем данные (в т.ч. и полученные из моделей).
