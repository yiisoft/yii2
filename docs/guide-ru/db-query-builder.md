...
заключается в игнорировании пустых значений, переданных в условие в [форме массива](#Формат-массива-). Таким образом
...
может быть определено тем же способом, что и для [where()](#yiidbquerywherewhere-).
...
Пожалуйста, обратитесь к документации для [where()](#yiidbquerywherewhere-) для более подробной информации о определении условий.
...
- `$on`: необязательное условие объединения, то есть фрагмент `ON`. Пожалуйста, обратитесь к документации для
  [where()](#yiidbquerywherewhere-) для более подробной информации о определении условий. Отметим, что синтаксис массивов **не работает**
