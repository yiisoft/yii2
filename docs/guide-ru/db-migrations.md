...
class m150101_185401_create_news_table extends Migration
{
    ...
    /*
    // Используйте safeUp()/safeDown() методы, чтобы запустить код миграции внутри транзакции
...
> Info: Кроме установки свойства [[yii\db\Migration::db|db]], Вы также можете работать с разными базами данных путем создания нового соединения с конкретной базой данных в классе Вашей миграции. Можно использовать [DAO методы](db-dao.md) с этими соединениями для манипулирования различными базами данных.
