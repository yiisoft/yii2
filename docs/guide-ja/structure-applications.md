...
アプリケーションは Yii アプリケーションシステム全体の構造とライフ・サイクルを統制するオブジェクトです。
...
このプロパティは、ログ・ファイルやキャッシュファイルなどの一時的ファイルを生成することが出来るパスを指定するものです。
...
このプロパティはビュー・ファイルが配置されるルートディレクトリを指定するものです。
...
## アプリケーションのライフ・サイクル<span id="application-lifecycle"></span>
